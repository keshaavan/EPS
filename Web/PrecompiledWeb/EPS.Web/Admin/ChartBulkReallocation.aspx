<%@ page language="C#" autoeventwireup="true" inherits="Admin_ChartBulkReallocation, App_Web_45n1udx5" %>
...
<div id="ChartBulkReallocationDisplay" style="height: 40px; margin-top: 5px;">
    <div class="floatleft" style="padding: 8px 2px 2px 1px; margin-left: 1px;">
        Date Type</div>
    <div class="floatleft" style="padding: 4px 1px 4px 2px; padding-left: 14px;">
...
<div id="ChartBulkReallocation" style="border-bottom: 1px solid #d3d3d3; height: 40px;
    margin-top: 5px;">
    <div class="floatleft" style="padding: 8px 2px 2px 1px; margin-left: 1px;">
        User Name
    </div>
    ...
    <div class="floatleft" style="padding: 8px 2px 2px 2px; margin-left: 200px;">
        From Status
    </div>
    ...
    <div class="floatleft" style="padding-left: 2px; margin-top: 5px;">
        <input type="button" id="btnMoved" value="Move" class="button" />
