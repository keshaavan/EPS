    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _setContainment: function () {
            ...
            if (o.containment === "document") {
                ...
                0,
                $(document)
                    .width() - this.helperProportions.width - this.margins.left, ($(document)
                    .height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top];
                return;
            }
    ...
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        _mouseStop: function (event, noPropagation) {
            ...
            if (this.options.revert) {
                ...
                this.reverting = true;
                $(this.helper)
                    .animate(animation, parseInt(this.options.revert, 10) || 500, function () {
                        that._clear(event);
                    });
            } else {
